...
// ввести число. Ввод сохраняется в переменную input и добавляется
...
// После того как пользователь прекратил ввод нажав Cancel, если
//  массив не пустой, необходимо посчитать сумму всех элементов
//   массива и записать ее в переменную total. Используй цикл
//    for или for...of. После чего в консоль выведи строку
...
do {
  ...
  if (!Number.isNaN(Number(input))) {
    ...
    alert("Это не число. В следующий раз введите число.");
  }
} while (input !== null);
